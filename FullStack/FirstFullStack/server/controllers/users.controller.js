...
//     // Notes: make sure id has underscore like below VERY IMPORTANT
...
//     // Option to use "new: true" if you want to update and overwrite original. 
//     //Not having this will return original get request even after trying to update
...
// Below is another way to modularize above code, either works
/*
module.exports = {
    allUsers: (req, res) => {
        User.find({})
